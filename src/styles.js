const styles = {
  ...
  heroHeadText:
    'font-black text-eerieBlack lg:text-[60px] sm:text-[60px] xs:text-[50px] text-[40px] lg:leading-[90px] mt-2',
  heroSubText:
  ...
  sectionSubText:
    'sm:text-[18px] text-[16px] text-white uppercase tracking-wider font-semibold font-poppins',
  sectionSubTextLight:
